	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class ProductsDataTable
			...
			Public Function AddProductsRow(ByVal ProductName As String, ByVal UnitPrice As Decimal, ByVal UnitsOnOrder As Short, ByVal Discontinued As Boolean) As ProductsRow
				...
				Dim columnValuesArray() As Object = { ProductName, UnitPrice, UnitsOnOrder, Discontinued}
...
Namespace DXGrid_NewItemRow.nwindDataSetTableAdapters
	...
	Partial Public Class ProductsTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT ProductName, UnitPrice, UnitsOnOrder, Discontinued FROM Products"
